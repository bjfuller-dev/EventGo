...
export default function LoginScreen(props) {
  ...
  // Function to check if the user is attending the event
    ...
    <SafeAreaView className="bg-white flex-1">
      <ScrollView>
        ...
        <View className="flex mx-10 space-y-4">
          ...
          <TouchableOpacity
            className="bg-slate-800 px-4 rounded-2xl"
            onPress={() => navigation.navigate("Record", { data: testDetails })}
          >
            <Text className="text-xl font-bold text-white text-center m-auto my-5">
              Payment Record
            </Text>
          ...
          <TouchableOpacity
            className="bg-slate-800 px-4 rounded-2xl"
            onPress={() =>
              navigation.navigate("Membership", { data: testDetails })
            }
          >
            <Text className="text-xl font-bold text-white text-center m-auto my-5">
              Membership Requests
        ...
        <TouchableWithoutFeedback
          onPress={() =>
            navigation.navigate("EventSettings", { data: testDetails.name, event: testDetails.event })
          }
        >
